...
passport.use(new FacebookStrategy({
    ...
    callbackURL: "http://www.dinewithdinex.com/auth/facebook/callback"
  },
...
app.get('/api/get_friends', function(req,res) {
	var options = {
...
function createDbTables(){
	/* table of users. contains all registered users, their autogenerated IDs,
	 * their phone numbers, email addresses */
    ...
    db.run("CREATE TABLE IF NOT EXISTS fbuser\
            (id INTEGER,\
            fbid INTEGER)");
    /* for dwolla. sadly I have no idea what sort of stuff you need to keep from
     * them in order to use their API */
    db.run("CREATE TABLE IF NOT EXISTS dwuser\
    	    (id INTEGER,\
    	    dwid INTEGER)");
}
